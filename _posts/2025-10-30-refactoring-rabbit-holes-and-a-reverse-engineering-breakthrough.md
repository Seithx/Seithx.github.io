...
*   I got an early start and decided to tackle a personal project I’ve picked up and dropped several times: reverse-engineering a notebook service's private API. The goal is to build a chat interface that uses it as a backend.
