...
A few things stood out over the last couple of days:
...
*   Paying technical debt is a grind. I'm continuing to write tests for our video analysis project to enable safe refactoring. It’s slow, painstaking work that shows the cost of starting a project without a solid testing foundation. A lesson learned the hard way.
...
*   Building from a clean slate feels great. After wrestling with the messy codebase at work, helping my friend build his website and story from scratch was a breath of fresh air. We got a nice site up, clarified his offerings, and talked about how he can present his skills to clients.

### Reflection

It’s been a lesson in contrasts. At work, we made the right call to avoid a complex feature, but I’m simultaneously feeling the pain of not having a solid foundation on another project. Then, helping my friend was a powerful reminder of how satisfying it is to build things the right way from day one. These contrasts offer valuable lessons in balancing different approaches to problem-solving.
